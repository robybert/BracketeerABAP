...
//        IConfigurationElement element = null; // stub
		for (final IConfigurationElement element : config) {
			...
			final String basePref = PreferencesConstants.Hints.preferencePath(pluginName,
			...
			addField(new BooleanFieldEditor(
					PreferencesConstants.preferencePath(pluginName) + PreferencesConstants.Hints.Globals.SHOW_IN_EDITOR,
...
//                                            "Display tooltip on hover", BooleanFieldEditor.DEFAULT, composite_3));
			...
			final Composite composite_16 = new Composite(composite_18, SWT.NONE);
			{
				final RadioGroupFieldEditor radioGroupFieldEditor = new RadioGroupFieldEditor(
						basePref + PreferencesConstants.Hints.Display.Ellipsis.ATTR, Messages.HintsPrefPage_Ellipsis, 1,
						new String[][] {
...
//                _prefNames.add(basePref + PreferencesConstants.Hints.WhenToShow.Criteria.ATTR);
	...
	public void propertyChange(final PropertyChangeEvent event) {
		...
		for (final TabInfo tabInfo : _tabInfos) {
			if (event.getSource() == tabInfo._displayUseDef || event.getSource() == tabInfo._fontUseDef
					|| event.getSource() == tabInfo._whenToShowUseDef || event.getSource() == tabInfo._fontBgDef
					|| event.getSource() == tabInfo._fontFgDef || event.getSource() == tabInfo._showInEditor
