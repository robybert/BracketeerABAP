...
public class MatchingStatements extends MatchObject {
	private final List<SingleStatement> _statements;

	public MatchingStatements(final int openingOffset, final char[] openingStatement, final int closingOffset,
			final char[] closingStatement) {
	...
	public boolean equals(final Object obj) {
		...
		/*
		 * for (SingleStatement bracket : _brackets) { if(!
		 * other.getBrackets().contains(bracket) ) return false; }
		 * 
		 * return true;
		 */
	}
	...
	public int getDistanceBetweenStatements() {
