...
public class BracketsPair extends MatchObject {
	private final List<SingleBracket> _brackets;

	public BracketsPair(final int openingOffset, final char openingChar, final int closingOffset,
	...
	public boolean equals(final Object obj) {
		...
		/*
		 * for (SingleBracket bracket : _brackets) { if(!
